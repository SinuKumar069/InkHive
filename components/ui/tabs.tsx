...
const tabsListVariants = cva(
  "group/tabs-list relative inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none before:pointer-events-none before:absolute before:content-[''] before:[transition:inset_var(--ease-and-timing)] before:[position-anchor:--tabs-anchor] before:[inset:anchor(inside)]",
  {
    variants: {
      variant: {
        default: "bg-muted",
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "hover:[anchor-name:--tabs-anchor] focus-visible:[anchor-name:--tabs-anchor]",
